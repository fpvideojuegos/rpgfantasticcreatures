export default class Wise extends Phaser.GameObjects.Sprite {
    ...
    //   }
   this.scene.registry.set(`${this.scene.registry.get('load')}_Wise_${this.number}`, 'picked'); //register this object as collected with game so it is not added to future intances of this level
