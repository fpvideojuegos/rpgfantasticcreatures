...
import DarkFireball from '../sprites/darkFireball.js';
import Slime from '../sprites/slime.js';
import Coins from '../sprites/coins.js';
import Meat from '../sprites/meat.js';
...
export default class Level extends Phaser.Scene {
  ...
  create() 
  {
    ...
    this.tileset = this.map.addTilesetImage(`${load}tiles`);  
  ...
  // });
    ...
    this.physics.add.collider(this.player, this.fiends);
